  ...
  <div className=" justify-start items-start">
   ...
   <br />
    <p className="ml-8">
      ...
      To get started checkout our documentation <Link href='https://dads-organization.gitbook.io/untitled/' target="_blank"><span className="font-semibold text-blue-800 text-lg"> here</span> </Link>
